...
int main() {
    ...
    printf("Размер третьего блока: %zu\n", getBlockLengthByGivenMemory(allocator, alloc3));
    ...
    printf("Размер 4-го блока: %ld\n", getBlockLengthByGivenMemory(allocator, alloc3 + 48 + 16));
    ...
    printf("Размер 6 блока: %zu\n", getBlockLengthByGivenMemory(allocator, alloc6));
    printf("ПОСЛЕ 1 %p\n", allocator->firstFreeBLock);
    printf("\n\n\n");
    ...
    printf("Начало первого блока: %zu\n", alloc1 - allocator->memory);
    printf("Размер первого блока: %zu\n", getBlockLengthByGivenMemory(allocator, alloc1));
    printf("Размер 2 блока: %zu\n", getBlockLengthByGivenMemory(allocator, alloc1 + 16));
    printf("Свободен: %zu\n", isBlockFree(alloc1 - 16));
    printf("Свободен: %zu\n", isBlockFree(alloc1 + 16));
